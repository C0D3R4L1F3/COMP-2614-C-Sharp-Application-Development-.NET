...
namespace COMP2614Assign06d
{
    ...
    public partial class MainForm : Form
    {
        ...
        {
            if (maskedTextBoxClientCode.Text == string.Empty || listBoxClients.Text == null)
            {
            ...
            else
            {
                ...
                if (result == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        listBoxClients.DataSource = clientVM.Clients;
                        listBoxClients.DisplayMember = "ClientCode";
                        toolStripStatusLabelStatus.Text = "Client has been successfully deleted";
        ...
        public void UpdateMode()
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                if (rowsAffected > 0)
                {
                    ...
                    toolStripStatusLabelStatus.Text = "Client has been successfully updated";
                    errorProviderMain.Clear();
                }
                else
                {
        ...
        public void AddMode()
        {
            ...
            if (rowsAffected > 0)
            {
                ...
                listBoxClients.DisplayMember = "ClientCode";
                listBoxClients.SelectedIndex = index;
                toolStripStatusLabelStatus.Text = "Client has been successfully added";
                errorProviderMain.Clear();
            }
            else
            {
        ...
        /// <param name="sender">the control/object to set</param>
        /// <param name="e">the event data to set</param>
        private void timerDateAndTimeDisplay_Tick(object sender, EventArgs e)
        {
